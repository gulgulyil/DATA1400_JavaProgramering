...
class film{
    ...
    public String getTitle(){ return tittel;}
...
public class klass2_KlasOgList {
    ...
    public static void main(String[]args){
        ...
        while(antall<filmer.length && innPris>0){
            ...
            antall++;
            innPris = Double.parseDouble(showInputDialog("Skriv inn på filmen, avslutt med 0 :"));
